...
def fill_img_with_sd(
    ...
    print(f"using {device} for fill_img_with_sd")
    ...
    img_crop_filled = pipe(
        ...
        negative_prompt="new objects, artifacts, inconsistent textures, asymmetry, text, signs, billboards, watermarks, humans, bushes, trees, shrubs, garden, vehicles"
    ).images[0]
